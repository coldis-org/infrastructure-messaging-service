...
JOURNAL_FILE_SIZE=$(( MAX_MEMORY * JOURNAL_FILE_SIZE_PERC / 100 ))
JOURNAL_FILE_SIZE=$(( JOURNAL_FILE_SIZE > JOURNAL_FILE_MAX_SIZE ? JOURNAL_FILE_MAX_SIZE : JOURNAL_FILE_SIZE ))
PAGE_SIZE=$(( MAX_MEMORY * PAGE_SIZE_PERC / 100 ))
PAGE_SIZE=$(( PAGE_SIZE > PAGE_MAX_SIZE ? PAGE_MAX_SIZE : PAGE_SIZE ))

export CONN_CONNECTIONS_ALLOWED GLOBAL_MAX_SIZE QUEUE_MAX_SIZE QUEUE_PRETECH_SIZE JOURNAL_FILE_SIZE PAGE_SIZE
