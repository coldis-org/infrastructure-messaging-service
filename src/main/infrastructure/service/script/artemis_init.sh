...
QUEUE_MAX_EXTRA_READ_SIZE_FROM_WINDOW_SIZE_MULT=$(( CONSUMER_WINDOW_SIZE * QUEUE_MAX_EXTRA_READ_SIZE_WINDOW_SIZE_MULT ))
QUEUE_MAX_EXTRA_READ_SIZE_FROM_MEM_PERC=$(( MAX_MEMORY * QUEUE_MAX_EXTRA_READ_SIZE_MEM_PERC / 100 ))
QUEUE_MAX_EXTRA_READ_SIZE=$(( QUEUE_MAX_EXTRA_READ_SIZE_FROM_WINDOW_SIZE_MULT > QUEUE_MAX_EXTRA_READ_SIZE_FROM_MEM_PERC ? QUEUE_MAX_EXTRA_READ_SIZE_FROM_WINDOW_SIZE_MULT : QUEUE_MAX_EXTRA_READ_SIZE_FROM_MEM_PERC ))
