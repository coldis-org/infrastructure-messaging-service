...
GLOBAL_MAX_SIZE=$(( MAX_MEMORY * MAX_GLOBAL_SIZE_MEM_PERC / 100 ))
QUEUE_MAX_SIZE=$(( MAX_MEMORY * MAX_QUEUE_SIZE_MEM_PERC / 100 ))
QUEUE_MAX_SIZE=$(( QUEUE_MAX_SIZE > INT_MAX ? INT_MAX : QUEUE_MAX_SIZE ))
QUEUE_PRETECH_SIZE=$(( MAX_MEMORY * PREFECTH_QUEUE_SIZE_MEM_PERC / 100 ))
